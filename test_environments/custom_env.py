...
class SnakeEnv(gym.Env):
    ...
    def step(self, action):
        ...
        apple_del_x = head_x - self.apple_position[0]
        apple_del_y = head_y - self.apple_position[1]

        snake_length = len(self.snake_position)

        self.observation = [head_x, head_y, apple_del_x, apple_del_y, snake_length] + list(self.prev_actions)
